...
// include: C:\Users\esteb\AppData\Local\Temp\tmp6ekfhd6z.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'sorting.data';
      var REMOTE_PACKAGE_BASE = 'sorting.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_sorting.data');

      };
      Module['addRunDependency']('datafile_sorting.data');
    ...
    loadPackage({"files": [{"filename": "/assets/blipSelect.wav", "start": 0, "end": 4478, "audio": 1}, {"filename": "/assets/enter.wav", "start": 4478, "end": 29457, "audio": 1}, {"filename": "/assets/set_sound.wav", "start": 29457, "end": 41140, "audio": 1}], "remote_package_size": 41140});

  })();

// end include: C:\Users\esteb\AppData\Local\Temp\tmp6ekfhd6z.js
// include: C:\Users\esteb\AppData\Local\Temp\tmp5ayhr4ve.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\esteb\AppData\Local\Temp\tmp5ayhr4ve.js
// include: C:\Users\esteb\AppData\Local\Temp\tmprn1748ge.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\esteb\AppData\Local\Temp\tmprn1748ge.js
